...
namespace Plantshop.Areas.Admin.Controllers
{
    ...
    public class BlogCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BlogCategoryId,Name,Description,Slug")] BlogCategory blogCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BlogCategoryId,Name,Description,Slug")] BlogCategory blogCategory)
        {
